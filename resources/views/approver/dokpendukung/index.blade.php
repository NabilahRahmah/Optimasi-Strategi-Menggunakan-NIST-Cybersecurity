    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="text-sm text-muted-foreground">
                Monitor semua dokumen • Total {{ $totalDokumen }} dokumen
            </p>
        </div>
                                        ...
                                        <td style="padding:14px 24px;text-align:center;">
                                            <div style="display:flex;gap:8px;justify-content:center;">
                                                @if(in_array($ext, ['pdf', 'jpg', 'jpeg', 'png']))
                                                    <button type="button"
                                                        onclick="openPreview('{{ route('approver.dokpendukung.preview', $dok->dok_id) }}', '{{ $dok->nama_dokumen }}', '{{ $ext }}')"
                                                ...
                                                @endif
                                                <a href="{{ route('approver.dokumen.download', $dok->dok_id) }}"
