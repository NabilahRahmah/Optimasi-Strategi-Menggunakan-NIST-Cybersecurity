...
<div class="space-y-8 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between mb-2">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-2">Kelola konfigurasi checklist</p>
        </div>
    ...
    <section class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
            ...
            <p class="mt-2 text-xs text-gray-500">Domain terdaftar</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
            ...
            <div class="mt-2 text-4xl font-black tracking-tight text-slate-800">{{ $total_pertanyaan ?? 0 }}</div>
            <p class="mt-2 text-xs text-gray-500">Total item assessment aktif</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
            ...
            <p class="mt-2 text-xs text-gray-500">Kategori Framework</p>
    ...
    <section class="rounded-2xl border border-red-100 bg-red-50/50 p-6 shadow-sm">
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex flex-wrap gap-3">
                @if(\Illuminate\Support\Facades\Route::has('admin.assessment.index'))
                    <a href="{{ route('admin.assessment.index') }}" class="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-red-800 shadow-md shadow-red-200">
                        Kelola Assessment
